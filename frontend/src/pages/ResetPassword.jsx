            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-pt-bg border border-pt-white/10 rounded-2xl py-5 pl-14 pr-12 text-pt-text font-black text-xs uppercase tracking-widest placeholder:text-pt-white/5 focus:outline-none focus:border-pt-primary transition-all shadow-inner"
                  required
                />
                <button
                  type="button"
